...
class MPIIDatasetCompatible(JointsDatasetCompatible):
    ...
    def __init__(self, cfg, image_set, is_train, transform=None):
        ...
        # Data Augmentation
        self.mpii_scale_factor = cfg.DATASET.MPII_SCALE_FACTOR
        self.mpii_rotation_factor = cfg.DATASET.MPII_ROT_FACTOR
        self.mpii_flip = cfg.DATASET.MPII_FLIP
        self.mpii_flip_pairs = self.get_flip_paris()
